...
func NewCreateTranslationFilesParams() CreateTranslationFilesParams {
	...
	return CreateTranslationFilesParams{}
}

// CreateTranslationFilesParams contains all the bound params for the create translation files operation
...
func (o *CreateTranslationFilesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body CreateTranslationFilesBody
