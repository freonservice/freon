...
func (o *CreateTranslationFilesURL) WithBasePath(bp string) *CreateTranslationFilesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateTranslationFilesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateTranslationFilesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateTranslationFilesURL")
	}
