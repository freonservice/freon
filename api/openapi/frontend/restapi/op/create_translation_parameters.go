...
func NewCreateTranslationParams() CreateTranslationParams {
	...
	return CreateTranslationParams{}
}

// CreateTranslationParams contains all the bound params for the create translation operation
...
func (o *CreateTranslationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body CreateTranslationBody
