...
func NewDeleteIdentifierParams() DeleteIdentifierParams {
	...
	return DeleteIdentifierParams{}
}

// DeleteIdentifierParams contains all the bound params for the delete identifier operation
...
func (o *DeleteIdentifierParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteIdentifierParams) validateID(formats strfmt.Registry) error {
