...
func (o *DeleteTranslationFileURL) WithBasePath(bp string) *DeleteTranslationFileURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteTranslationFileURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteTranslationFileURL")
	}
...
func (o *DeleteTranslationFileURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTranslationFileURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTranslationFileURL")
	}
