...
func (o *DeleteTranslationURL) Build() (*url.URL, error) {
	...
	var _path = "/translation/{id}"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DeleteTranslationURL")
	}
...
func (o *DeleteTranslationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTranslationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTranslationURL")
	}
