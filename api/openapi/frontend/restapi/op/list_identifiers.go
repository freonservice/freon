...
func (fn ListIdentifiersHandlerFunc) Handle(params ListIdentifiersParams, principal *app.UserSession) ListIdentifiersResponder {
...
func NewListIdentifiers(ctx *middleware.Context, handler ListIdentifiersHandler) *ListIdentifiers {
	return &ListIdentifiers{Context: ctx, Handler: handler}
}
...
func (o *ListIdentifiers) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewListIdentifiersParams()
