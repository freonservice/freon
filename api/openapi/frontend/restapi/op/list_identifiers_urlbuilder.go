...
func (o *ListIdentifiersURL) Build() (*url.URL, error) {
	...
	if categoryIDQ != "" {
		qs.Set("category_id", categoryIDQ)
	}
...
func (o *ListIdentifiersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListIdentifiersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListIdentifiersURL")
	}
