...
func NewSettingTranslationParams() SettingTranslationParams {
	...
	return SettingTranslationParams{}
}

// SettingTranslationParams contains all the bound params for the setting translation operation
...
func (o *SettingTranslationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body SettingTranslationBody
