...
func NewSupportedLanguagesParams() SupportedLanguagesParams {
	...
	return SupportedLanguagesParams{}
}

// SupportedLanguagesParams contains all the bound params for the supported languages operation
...
func (o *SupportedLanguagesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
