...
func NewUpdateTranslationParams() UpdateTranslationParams {
	...
	return UpdateTranslationParams{}
}

// UpdateTranslationParams contains all the bound params for the update translation operation
...
func (o *UpdateTranslationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body UpdateTranslationBody
...
func (o *UpdateTranslationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateTranslationParams) validateID(formats strfmt.Registry) error {
