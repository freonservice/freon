...
// UserChangePasswordParams contains all the bound params for the user change password operation
...
func (o *UserChangePasswordParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
