...
func NewUserChangeProfileParams() UserChangeProfileParams {
	...
	return UserChangeProfileParams{}
}

// UserChangeProfileParams contains all the bound params for the user change profile operation
...
func (o *UserChangeProfileParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body UserChangeProfileBody
